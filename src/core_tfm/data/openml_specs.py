...
CLASSIFICATION_DATASETS = {
    ...
    # The completed bounded protocol retains Marketing and uses constrained
    # training subsamples for class coverage. Its rare response class remains
    # a stated threat to validity and requires an exclusion sensitivity.
